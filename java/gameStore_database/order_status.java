...
public final class order_status extends javax.swing.JFrame {
    Connection con;
    Statement stmt;
    ResultSet rs;
    int curRow = 0;
...
public void DoConnection(){
        try {
            ...
            String query = "select status_code, status_description, order_id from order_status";
            rs = stmt.executeQuery(query);
            btnSave.setEnabled(false);
            btnCancel.setEnabled(false);
        } catch (SQLException err) {
            JOptionPane.showMessageDialog(order_status.this, err.getMessage()); }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("status_code");

        jLabel2.setText("status_description");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtBox2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE)
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            rs = stmt.executeQuery(query);
            rs.next();
            String A = rs.getString("status_code");
            String B = rs.getString("status_description");
            String C = rs.getString("order_id");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            rs.updateString("status_code", A);
            rs.updateString("status_description", B);
            rs.updateString("order_id", C);

            rs.updateRow();
            JOptionPane.showMessageDialog(order_status.this, "Updated");
        } catch (SQLException err) {
            JOptionPane.showMessageDialog(order_status.this, err.getMessage()); }
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        try {
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(order_status.this, "End of Database");
            }
        } catch (SQLException err) {
            JOptionPane.showMessageDialog(order_status.this, err.getMessage()); }
    ...
    private void btnPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrevActionPerformed
        ...
        try {
            if (rs.previous()){
                ...
                JOptionPane.showMessageDialog(order_status.this, "Start of Database");
            }
        } catch (SQLException err) {
            JOptionPane.showMessageDialog(order_status.this, err.getMessage()); }
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        try {
            rs.absolute( curRow );
            txtBox1.setText( rs.getString("status_code"));
            txtBox2.setText( rs.getString("status_description"));
            txtBox3.setText( rs.getString("order_id"));
